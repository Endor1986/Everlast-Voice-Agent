...
export default function Page() {
  ...
  function push(role: "user" | "agent", text: string) {
    setChat((c) => [...c, { id: uid(), role, text, ts: Date.now() }]);
  }
        ...
        <div style={controlCard}>
          ...
          <select
            ...
            onChange={(e) => {
              ...
              if (v === "pro" && proDisabled) {
                alert("Pro Mode ist in Tag 1 deaktiviert.");
                return;
              }
              setMode(v);
            }}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 12 }}>
        <div style={card}>
          ...
          {flowState === "ASK_CONTACT" && (
            <div style={{ marginTop: 14, background: "#fff", border: "1px solid #e7e7e7", borderRadius: 12, padding: 12 }}>
        ...
        <div style={card}>
          ...
          <div style={{ marginTop: 12, background: "#fff", border: "1px solid #e7e7e7", borderRadius: 12, padding: 12 }}>
